...
class GreenhouseContext(BaseModel):
    ...
    shading_screen_installed: bool = Field(default=False)
    shading_screen_deployment_pct: float = Field(default=0.0, ge=0.0, le=100.0)
    effective_transmittance: float = Field(default=0.85, ge=0.0, le=1.0)
