        ...
        thermal_input = ThermalInput(
            ...
            equipment=ClimateEquipmentInput(
                ...
                sizing=ClimateEquipmentSizingInput(
                    ...
                    exhaust_fan_rated_flow_m3h=payload.equipment.sizing.exhaust_fan_rated_flow_m3h,
                    roof_exhaust_fan_rated_flow_m3h=payload.equipment.sizing.roof_exhaust_fan_rated_flow_m3h,
                    circulation_fan_rated_flow_m3h=payload.equipment.sizing.circulation_fan_rated_flow_m3h,
                    circulation_fan_motor_w=payload.equipment.sizing.circulation_fan_motor_w,
                    ac_rated_cooling_kw_per_unit=payload.equipment.sizing.ac_rated_cooling_kw_per_unit,
                    ac_shr=payload.equipment.sizing.ac_shr,
                    ac_cop=payload.equipment.sizing.ac_cop,
                    ac_supply_airflow_m3h=payload.equipment.sizing.ac_supply_airflow_m3h,
                    heater_rated_kw_per_unit=payload.equipment.sizing.heater_rated_kw_per_unit,
                    geothermal_rated_kw=payload.equipment.sizing.geothermal_rated_kw,
                    geothermal_cop=payload.equipment.sizing.geothermal_cop,
                    hot_water_heating_kw=payload.equipment.sizing.hot_water_heating_kw,
                    pad_efficiency=payload.equipment.sizing.pad_efficiency,
                    fog_nozzle_flow_lh_per_line=payload.equipment.sizing.fog_nozzle_flow_lh_per_line,
                    fog_evaporation_efficiency=payload.equipment.sizing.fog_evaporation_efficiency,
                    leakage_ach=payload.equipment.sizing.leakage_ach,
                ),
            ),
